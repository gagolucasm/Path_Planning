...
vector<double> getXY(double s, double d, std::vector<double> maps_s,
                     vector<double> maps_x, vector<double> maps_y) {
  int prev_wp = -1;
...
void globaltToCarSpace(double ref_x, double ref_y, double ref_yaw,
...
enum Street { LEFT_LANE = 0, CENTER_LANE = 1, RIGHT_LANE = 2 };
}
